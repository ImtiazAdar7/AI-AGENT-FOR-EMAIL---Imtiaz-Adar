...
class EmailAgent:
    ...
    # List of available Gemini models (fallback options)
    AVAILABLE_MODELS = [
        'gemini-2.5-flash',
        'gemini-1.5-flash',
        'gemini-1.5-pro',
    ...
    def _initialize_model(self):
        ...
        try:
            ...
            # If none of the preferred models work, try any available
...
def main():
    ...
    with col1:
        st.image(icon, width=60)  # Adjust width as needed
...
""", unsafe_allow_html=True)
    ...
    if not hasattr(st.session_state, 'initialized') or not st.session_state.initialized:
        ...
        with st.expander("📚 Quick Start Guide (FREE)", expanded=True):
            ...
            - **Generate professional emails** from scratch
